...
from .stats_routes import admin_stats_bp
from .photo_routes import admin_photo_bp
...
admin_bp.register_blueprint(admin_stats_bp)
admin_bp.register_blueprint(admin_photo_bp)
